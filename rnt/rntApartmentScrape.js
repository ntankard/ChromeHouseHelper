...
function scrapeApartment() {
    ...
    building.constructionDateYear = parseInt(detailList.children[15].innerHTML.split("年")[0]);
    building.constructionDateMonth = parseInt(detailList.children[15].innerHTML.split("年")[1].replace("月", ""));
